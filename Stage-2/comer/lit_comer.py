...
class LitCoMER(pl.LightningModule):
    ...
    def freeze_word_embedding(self):
        for param in self.comer_model.decoder.word_embed.parameters():
            param.requires_grad = False
    
    def load_from_pretrained(self, path: str):
        checkpoint = torch.load(path)
        model_dict = self.comer_model.state_dict()
        ...
        self.freeze_word_embedding()
        
        print("Freezed word embedding")
