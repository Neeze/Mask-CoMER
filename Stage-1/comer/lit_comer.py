...
from comer.utils.utils import (ExpRateRecorder, 
                               Hypothesis,
                               ce_loss,
                               MaskPredAccuracy)
...
class LitCoMER(pl.LightningModule):
    def __init__(
        ...
        self.mask_accuracy = MaskPredAccuracy()
    ...
    def validation_step(self, batch: Batch, _):
        ...
        self.mask_accuracy(out_hat, labels)
        self.log("val_accuracy", self.mask_accuracy, on_step=False, on_epoch=True, prog_bar=True, sync_dist=True)
